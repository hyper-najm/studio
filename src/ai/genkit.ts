...
if (!apiKey) {
  console.warn(
    'GOOGLE_API_KEY is not set in environment variables. Genkit AI features may not work or may result in errors. Ensure this variable is set in your environment with a valid Google AI API key.'
  );
